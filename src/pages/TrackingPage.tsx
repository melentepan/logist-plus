  ...
  return (
    <main className="container mx-auto px-4 py-8">
      <div className="max-w-6xl mx-auto">
        <div className="mb-8">
          <h1 className="text-3xl font-bold text-gold mb-2">Отслеживание грузов</h1>
          <p className="text-medium">Мониторинг ваших автомобилей в реальном времени</p>
        </div>
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-8">
          ...
          <Card className="lg:col-span-1">
            <CardHeader>
              ...
              <CardDescription>Местоположение автомобилей в реальном времени</CardDescription>
            </CardHeader>
            <CardContent>
              <div className="bg-gray-100 rounded-lg h-96 flex items-center justify-center relative overflow-hidden">
                ...
                <div className="absolute inset-0 bg-blue-500/10 flex items-center justify-center">
                  <div className="text-center">
                    ...
                    <p className="text-sm text-gray-700">Интерактивная карта</p>
                    <p className="text-xs text-gray-600">Отображение в реальном времени</p>
                  </div>
                </div>
              </div>
            </CardContent>
          ...
          <Card className="lg:col-span-1">
            <CardHeader>
              ...
              <CardDescription>Текущий статус и местоположение</CardDescription>
            </CardHeader>
            <CardContent>
                  ...
                  <div key={vehicle.id} className="border rounded-lg p-4 space-y-3">
                    <div className="flex items-center justify-between">
                      <div className="flex items-center gap-3">
                        ...
                        <div>
                          ...
                          <p className="text-sm text-bright">{vehicle.driver}</p>
                        </div>
                      </div>
                    ...
                    <div className="space-y-2 text-sm">
                      <div className="flex items-center gap-2">
                        ...
                        <span className="text-bright">{vehicle.location}</span>
                      </div>
                      <div className="flex items-center gap-2">
                        <MapPin className="h-4 w-4 text-bright" />
                        <span className="text-medium">{vehicle.coordinates}</span>
                      </div>
                      <div className="flex items-center gap-2">
                        <Clock className="h-4 w-4 text-bright" />
                        <span className="text-bright">ETA: {vehicle.eta}</span>
                      </div>
                    </div>

                    <div className="space-y-2">
                      <div className="flex justify-between text-sm">
                        <span className="text-bright">Груз: {vehicle.cargo}</span>
                        <span className="text-bright">{vehicle.progress}%</span>
                      </div>
                      <div className="w-full bg-gray-200 rounded-full h-2">
                        <div
                          className={`h-2 rounded-full ${getStatusColor(vehicle.status)}`}
