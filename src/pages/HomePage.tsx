    ...
    <main className="container mx-auto px-4 py-8">
      <div className="max-w-4xl mx-auto">
        ...
        <div className="text-center mb-8">
          ...
          <p className="text-xl text-medium">Найдите надежного перевозчика для вашего груза</p>
        </div>
        ...
        <Card className="mb-8">
          <CardHeader>
            ...
            <CardDescription>Укажите детали вашего груза для поиска подходящего перевозчика</CardDescription>
          </CardHeader>
          <CardContent className="space-y-6">
            ...
            {/* Габариты груза */}
            <div>
              <Label className="text-base font-medium mb-4 block">Габариты груза</Label>
          ...
          <Card>
            <CardContent className="pt-6">
              <div className="text-center">
                ...
                <div className="text-sm text-bright">Проверенных перевозчиков</div>
              </div>
            </CardContent>
          </Card>
