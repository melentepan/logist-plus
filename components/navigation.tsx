        ...
        return (
          <Link
            ...
            className={`flex items-center gap-2 px-3 py-2 rounded-md text-sm font-medium transition-colors ${
              isActive ? "bg-gold/20 text-gold" : "text-gray-400 hover:text-light-gray hover:bg-hover-bg"
      ...
      <div className="container mx-auto px-4">
        <div className="flex items-center justify-between h-16">
          ...
          <Link href="/" className="flex items-center gap-2">
            <Image src="/logist_logo.png" alt="Logist+ Logo" width={32} height={32} className="rounded-full" />
            ...
            <Sheet open={isOpen} onOpenChange={setIsOpen}>
              ...
              <SheetContent side="right" className="w-64">
                <div className="flex items-center gap-2 mb-8">
                  <Image src="/logist_logo.png" alt="Logist+ Logo" width={24} height={24} className="rounded-full" />
